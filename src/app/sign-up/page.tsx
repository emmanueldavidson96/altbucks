        ...
        <div className='flex justify-around w-[90%] mx-auto my-12'>
            ...
            <div className='bg-white w-[50%] rounded-3xl px-16 py-16 flex flex-col gap-4'>
                ...
                <div className='flex flex-col gap-6'>
                    {/* Earn */}
                    <div className='flex w-full items-center border border-blue-500 rounded-xl p-4 gap-6'>
                    ...
                    {/* Create Task */}
                    <div className='flex w-full items-center border border-gray-300 rounded-xl p-4 gap-6'> 
