    ...
    <div className="w-full flex flex-col items-center justify-center py-10 lg:h-[500px] gap-5">
      ...
      <div className="w-[80%] mt-12 mx-auto flex flex-col gap-5 lg:flex-row justify-between relative">
        ...
        <Image
          src={first_arrowImg}
          alt=""
          className="h-[40px] w-[200px] hidden lg:block absolute top-1 left-[200px] "
        />
        ...
        <div className="flex flex-col gap-3 lg:w-[20%] items-center justify-center">
          <div className="w-[60px] h-[60px] rounded-full bg-[#2877EA] flex items-center justify-center">
            <Image
              src={complete_taskImg}
              alt=""
              className="w-[25px] h-[25px] object-cover z-10"
            />
          </div>
        ...
        <Image
          src={second_arrowImg}
          alt=""
          className="h-[40px] w-[200px] hidden lg:block absolute top-6 left-[580px] "
        />
        ...
        <Image
          src={third_arrowImg}
          alt=""
          className="h-[40px] hidden lg:block w-[200px] absolute top-1 left-[930px] "
        />
