...
function ViewReviews() {
  return (
    <div className='bg-[#F1F2F4] h-[600px] w-full flex flex-col items-center justify-center gap-16 relative'>
      <h2 className='font-semibold text-3xl text-black tracking-wide'>
        View Reviews
      </h2>
      ...
      <Image
        src={imgOne}
        alt=''
        className='absolute w-[50px] h-[50px] object-cover bottom-16 left-48'
      />
      <Image
        src={imgTwo}
        alt=''
        className='absolute w-[50px] h-[50px] object-cover bottom-60 left-28'
      />
      <Image
        src={imgThree}
        alt=''
        className='absolute w-[50px] h-[50px] object-cover top-24 left-44'
      />
      <Image
        src={imgFour}
        alt=''
        className='absolute w-[50px] h-[50px] object-cover top-24 right-44'
      />
      <Image
        src={imgFive}
        alt=''
        className='absolute w-[50px] h-[50px] object-cover bottom-60 right-28'
      />
      <Image
        src={imgSix}
        alt=''
        className='absolute w-[50px] h-[50px] object-cover bottom-16 right-48'
      />
          ...
          <div className='w-full h-[300px] bg-white rounded-2xl flex flex-col items-center justify-center shadow-xl relative'>
            <div className='flex w-[70%] flex-col gap-1 items-center justify-center'>
              <p className='tracking-wide text-black text-base'>
                Taskers are paid upon successfully completing tasks, ensuring
