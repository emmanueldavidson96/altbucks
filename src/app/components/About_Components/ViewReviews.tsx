...
function ViewReviews() {
  return (
    <div className='bg-[#F1F2F4] h-[600px] w-full flex flex-col items-center justify-center gap-16 relative'>
        <h2 className='font-semibold text-3xl text-black tracking-wide'>Reviewed by the community</h2>
        ...
        <Image src={imgOne} alt='' className='absolute w-[50px] h-[50px] object-cover bottom-16 left-56'/>
        <Image src={imgTwo} alt='' className='absolute w-[50px] h-[50px] object-cover bottom-60 left-36'/>
        <Image src={imgThree} alt='' className='absolute w-[50px] h-[50px] object-cover top-24 left-52'/>
        <Image src={imgFour} alt='' className='absolute w-[50px] h-[50px] object-cover top-24 right-52'/>
        <Image src={imgFive} alt='' className='absolute w-[50px] h-[50px] object-cover bottom-60 right-36'/>
        <Image src={imgSix} alt='' className='absolute w-[50px] h-[50px] object-cover bottom-16 right-56'/>
